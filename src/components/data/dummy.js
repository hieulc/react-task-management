...
import { MdFilterList, MdOutlineDelete } from "react-icons/md";
...
const rows = [
  ...
  createData("Lollipop", 392, 0.2, 0.0),
  createData("Marshmallow", 318, 0, 2.0),
  createData("Nougat", 360, 19.0, 37.0),
  createData("Oreo", 437, 18.0, 4.0),
];
